        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    console.mensagemSucesso("=== ALUNO CADASTRADO COM SUCESSO! ID: " + aluno.getId());
                    console.pause();
                ...
                case 2:
                    ...
                    console.mensagemSucesso("=== PROFESSOR CADASTRADO COM SUCESSO! ID: " + professor.getId());
                    console.pause();
                ...
                case 3:
                    ...
                    console.mensagemSucesso("=== ADMINISTRATIVO CADASTRADO COM SUCESSO! ID: " + admin.getId());
                    console.pause();
